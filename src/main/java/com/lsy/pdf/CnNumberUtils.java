...
public class CnNumberUtils {
    ...
    public static void main(String[] args) {
        String re = toUppercase(3456.2);
        System.out.println(re);
        System.out.println(toUppercase("￥5794.45"));
        System.out.println("182452374a9d4f323ed3c657fc11f85fa6bd02f2ecc149287f6f3bf71ce075d8".length());
